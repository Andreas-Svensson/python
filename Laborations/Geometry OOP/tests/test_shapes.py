...
class TestCircle(unittest.TestCase):  # TestCircle sub-class of TestCase
    ...
    def test_equality_operator(self):
        ...
        c_small = self.create_circle(0.5, 0.5, 0.5)
...
class TestRectangle(unittest.TestCase):  # TestRectangle sub-class of TestCase
    ...
    def test_equality_operator(self):
        ...
        r_small = self.create_rectangle(0.5, 0.5, 0.5, 0.5)
    ...
    def test_contains_point_true(self):
        ...
        self.assertTrue(
            r.contains_point(self.x + self.w / 2, self.y + self.h / 2)
        )  # top right corner
        self.assertTrue(
            r.contains_point(self.x - self.w / 2, self.y + self.h / 2)
        )  # top left corner
    ...
    def test_contains_point_false(self):
        ...
        self.assertFalse(
            r.contains_point(self.x + self.w / 0.9, self.y + self.h / 0.9)
        )  # top right corner
        self.assertFalse(
            r.contains_point(self.x - self.w / 0.9, self.y + self.h / 0.9)
        )  # top left corner
...
class TestCircle(unittest.TestCase):  # TestCircle sub-class of TestCase
    ...
    def test_equality_operator(self):
        ...
        c_small = self.create_sphere(0.5, 0.5, 0.5, 0.5)
    ...
    def test_contains_point_false(self):
        ...
        self.assertFalse(
            c.contains_point(self.x + self.r + 1, self.y, self.z)
        )  # x + r + 1
        self.assertFalse(
            c.contains_point(self.x, self.y + self.r + 1, self.z)
        )  # y + r + 1
        self.assertFalse(
            c.contains_point(self.x, self.y, self.z + self.r + 1)
        )  # z + r + 1
...
class TestCuboid(unittest.TestCase):  # TestCuboid sub-class of TestCase
    ...
    def test_equality_operator(self):
        ...
        c_small = self.create_cuboid(0.5, 0.5, 0.5, 0.5, 0.5, 0.5)
    ...
    def test_calculate_area(self):
        ...
        c = self.create_cuboid()
        self.assertEqual(
            c.area, (2 * (self.w * self.h + self.h * self.l + self.l * self.w))
        )
    ...
    def test_contains_point_false(self):
        ...
        self.assertFalse(
            c.contains_point(
                self.x + self.w / 0.9, self.y + self.h / 0.9, self.z + self.l / 0.9
            )
        )  # top corner 1
        self.assertFalse(
            c.contains_point(
